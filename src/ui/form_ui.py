...
"")
        ...
        sizePolicy2.setHeightForWidth(self.generate_button.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy2.setHeightForWidth(self.upload_button.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, View):
        ...
        self.label_w.setText(QCoreApplication.translate("View", u"W", None))
        self.height.setText(QCoreApplication.translate("View", u"5", None))
        self.label_h.setText(QCoreApplication.translate("View", u"H", None))
        self.width.setText(QCoreApplication.translate("View", u"5", None))
